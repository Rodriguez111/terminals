<style><%@include file="/resources/css/main/login.css" %></style>
    ...
    <form method='post' action="${pageContext.servletContext.contextPath}<%="/login"%>">
        <table>
            ...
            <tr>
                ...
                <img id="img" src="${pageContext.servletContext.contextPath}/resources/png/login_icon.png" alt="logo"  height="40px" />
            </tr>
        </table>
    </form>
</div>
