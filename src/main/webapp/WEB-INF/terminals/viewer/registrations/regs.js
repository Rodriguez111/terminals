...
function sendTerminalInventoryId() {
    ...
    sendAjaxData('${pageContext.servletContext.contextPath}/terminalinputvalidate', inventoryId, callback);
    inputTerminalField.value = '';
}
...
function giveTerminalToUser() {
    ...
    var whoGaveLogin = hiddenElementAdminLogin.value;
    var dataToSend = JSON.stringify({userInputLogin:userInputLogin, terminalId:terminalId, whoGaveLogin:whoGaveLogin});
    ...
    function callback(data) {
        ...
        if (typeof str.terminalGivingSuccess !== 'undefined') {
            document.getElementById("userNameInfo").innerHTML = str.surname + " " + str.name;
            loadTerminalsStatistic(str.totalAmountOfTerminals, str.amountOfInactiveTerminals, str.amountOfGivenTerminals, str.activeTerminalsRemain);
    ...
    sendAjaxData('${pageContext.servletContext.contextPath}/givevalidate', dataToSend, callback);
    inputUserField.value = '';
}
...
function receiveTerminalFromUser() {
    var userInputLogin = inputUserField.value;
    var hiddenElementAdminLogin = document.getElementById("adminLogin");
    var whoReceivedLogin = hiddenElementAdminLogin.value;
    var dataToSend = JSON.stringify({userInputLogin:userInputLogin, terminalId:terminalId, whoReceivedLogin:whoReceivedLogin});
    ...
    sendAjaxData('${pageContext.servletContext.contextPath}/receivevalidate', dataToSend, callback);
    inputUserField.value = '';
}
